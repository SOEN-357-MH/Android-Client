    ...
    override fun onCreateView(
        ...
        args.mediaBody.providers?.results?.let {
            it.CA?.flatrate?.let { providers ->
                ...
                binding.dLogosRV.layoutManager =
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.addMovieToWatchlistResponse.collect { event ->
                when (event) {
                    ...
                    is HomeViewModel.AddMovieToWatchlistEvent.Failure -> Toast.makeText(
                        requireContext(),
                        event.errorText,
                        Toast.LENGTH_SHORT
                    ).show()
                    ...
                    is HomeViewModel.AddMovieToWatchlistEvent.Exception -> Toast.makeText(
                        requireContext(),
                        event.exceptionText,
                        Toast.LENGTH_SHORT
                    ).show()
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.addShowToWatchlistResponse.collect { event ->
                when (event) {
                    ...
                    is HomeViewModel.AddShowToWatchlistEvent.Failure -> Toast.makeText(
                        requireContext(),
                        event.errorText,
                        Toast.LENGTH_SHORT
                    ).show()
                    ...
                    is HomeViewModel.AddShowToWatchlistEvent.Exception -> Toast.makeText(
                        requireContext(),
                        event.exceptionText,
                        Toast.LENGTH_SHORT
                    ).show()
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.removeMovieFromWatchlistResponse.collect { event ->
                when (event) {
                    ...
                    is HomeViewModel.RemoveMovieFromWatchlistEvent.Failure -> Toast.makeText(
                        requireContext(),
                        event.errorText,
                        Toast.LENGTH_SHORT
                    ).show()
                    ...
                    is HomeViewModel.RemoveMovieFromWatchlistEvent.Exception -> Toast.makeText(
                        requireContext(),
                        event.exceptionText,
                        Toast.LENGTH_SHORT
                    ).show()
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.removeShowFromWatchlistResponse.collect { event ->
                when (event) {
                    ...
                    is HomeViewModel.RemoveShowFromWatchlistEvent.Failure -> Toast.makeText(
                        requireContext(),
                        event.errorText,
                        Toast.LENGTH_SHORT
                    ).show()
                    ...
                    is HomeViewModel.RemoveShowFromWatchlistEvent.Exception -> Toast.makeText(
                        requireContext(),
                        event.exceptionText,
                        Toast.LENGTH_SHORT
                    ).show()
